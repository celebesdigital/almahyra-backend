...
<div class="mb-3">
	<a href="/backend/mitra-list/registrasi-ao">
		<button type="button" class="btn btn-primary w-100">Tambahkan Mitra AO</button>
	</a>
</div>
...
<div class="row row-cols-1 row-cols-lg-2 row-cols-xl-4">
	...
	<div class="col">
		<div class="card radius-15">
			<div class="card-body text-center">
				<div class="p-4 border radius-15">
					<img src="/images/avatars/avatar-2.png" width="110" height="110" class="rounded-circle shadow" alt="">
	...
	<div class="col">
		<div class="card radius-15">
			<div class="card-body text-center">
				<div class="p-4 border radius-15">
					<img src="/images/avatars/avatar-3.png" width="110" height="110" class="rounded-circle shadow" alt="">
	...
	<div class="col">
		<div class="card radius-15">
			<div class="card-body text-center">
				<div class="p-4 border radius-15">
					<img src="/images/avatars/avatar-4.png" width="110" height="110" class="rounded-circle shadow" alt="">
