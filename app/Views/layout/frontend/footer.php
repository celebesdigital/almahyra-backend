					...
					<div class="row">
						...
						<div class="col-xl-3">
							<div class="footer-info">
								<img class="footer-logo" src="/_web/images/logo-pink.png" alt="footer-logo">
							</div>
						</div>
								...
								<form class="newsletter-form">
									...
									<div class="input-group r-06">
										...
										<span class="input-group-btn ico-15">
											<button type="submit" class="btn color--pink-400">
...
<!-- Mirrored from dsathemes.com/html/martex/files/demo-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Jun 2023 13:14:19 GMT -->
</html>