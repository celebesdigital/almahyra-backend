<?php
	$this->extend('layout/frontend/header');
			...
			<section id="lnk-2" class="pt-100 ct-02 content-section division">
				<div class="container">
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-6">
							<div class="img-block left-column wow fadeInRight">
								<img class="img-fluid" src="/_web/images/img-03.png" alt="content-image">
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="txt-block right-column wow fadeInLeft">
								...
								<div class="txt-box mb-0">
									...
									<!-- Button -->
									<a href="#features-2" class="btn btn-sm r-04 btn--tra-black hover--pink-400">
									What's possible?
									</a>
						...
						<div class="col-md-5">
							<div class="txt-block left-column wow fadeInRight">
								...
								<div class="cbox-1 ico-15">
									...
									<div class="ico-wrap color--pink-400">
										...
										<div id="fb-12-1" class="fbox-12 bg--white-100 block-shadow r-12 mb-30">
											...
											<div class="fbox-ico ico-50">
												<div class="shape-ico">
													...
													<!-- Vector Icon -->
													<span class="flaticon-layers-1 color--pink-400"></span>
										...
										<div id="fb-12-2" class="fbox-12 bg--white-100 block-shadow r-12">
											...
											<div class="fbox-ico ico-50">
												<div class="shape-ico">
													...
													<!-- Vector Icon -->
													<span class="flaticon-tutorial color--pink-400"></span>
										...
										<div id="fb-12-3" class="fbox-12 bg--white-100 block-shadow r-12 mb-30">
											...
											<div class="fbox-ico ico-50">
												<div class="shape-ico">
													...
													<!-- Vector Icon -->
													<span class="flaticon-pay-per-click color--pink-400"></span>
										...
										<div id="fb-12-4" class="fbox-12 bg--white-100 block-shadow r-12">
											...
											<div class="fbox-ico ico-50">
												<div class="shape-ico">
													...
													<!-- Vector Icon -->
													<span class="flaticon-taxes color--pink-400"></span>
			...
			<section class="py-100 ct-02 content-section division">
				<div class="container">
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-6">
							<div class="img-block left-column wow fadeInRight">
								<img class="img-fluid" src="/_web/images/img-02.png" alt="content-image">
							</div>
						</div>
						...
						<div class="col text-center">
							<div class="owl-carousel brands-carousel-5">
								...
								<div class="brand-logo">
									<a href="#"><img class="img-fluid" src="/_web/images/brand-1.png" alt="brand-logo"></a>
								</div>


								<!-- BRAND LOGO IMAGE -->
								<div class="brand-logo">
									<a href="#"><img class="img-fluid" src="/_web/images/brand-2.png" alt="brand-logo"></a>
								</div>


								<!-- BRAND LOGO IMAGE -->
								<div class="brand-logo">
									<a href="#"><img class="img-fluid" src="/_web/images/brand-3.png" alt="brand-logo"></a>
								</div>


								<!-- BRAND LOGO IMAGE -->
								<div class="brand-logo">
									<a href="#"><img class="img-fluid" src="/_web/images/brand-4.png" alt="brand-logo"></a>
								</div>


								<!-- BRAND LOGO IMAGE -->
								<div class="brand-logo">
									<a href="#"><img class="img-fluid" src="/_web/images/brand-5.png" alt="brand-logo"></a>
								</div>


								<!-- BRAND LOGO IMAGE -->
								<div class="brand-logo">
									<a href="#"><img class="img-fluid" src="/_web/images/brand-6.png" alt="brand-logo"></a>
								</div>


								<!-- BRAND LOGO IMAGE -->
								<div class="brand-logo">
									<a href="#"><img class="img-fluid" src="/_web/images/brand-7.png" alt="brand-logo"></a>
								</div>


								<!-- BRAND LOGO IMAGE -->
								<div class="brand-logo">
									<a href="#"><img class="img-fluid" src="/_web/images/brand-8.png" alt="brand-logo"></a>
								</div>


								<!-- BRAND LOGO IMAGE -->
								<div class="brand-logo">
									<a href="#"><img class="img-fluid" src="/_web/images/brand-9.png" alt="brand-logo"></a>
								</div>
						...
						<div class="row row-cols-1 row-cols-md-3">
							...
							<div class="col">
								<div class="fbox-2 fb-1 wow fadeInUp">
									...
									<div class="fbox-img gr--whitesmoke h-175">
										<img class="img-fluid" src="/_web/images/f_01.png" alt="feature-image">
									</div>
							...
							<div class="col">
								<div class="fbox-2 fb-2 wow fadeInUp">
									...
									<!-- Image -->
									<div class="fbox-img gr--whitesmoke h-175">
										<img class="img-fluid" src="/_web/images/f_05.png" alt="feature-image">
									</div>
							...
							<div class="col">
								<div class="fbox-2 fb-3 wow fadeInUp">
									...
									<!-- Image -->
									<div class="fbox-img gr--whitesmoke h-175">
										<img class="img-fluid" src="/_web/images/f_02.png" alt="feature-image">
									</div>
			...
			<section class="pt-100 ct-01 content-section division">
				<div class="container">
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-6 order-first order-md-2">
							<div class="img-block right-column wow fadeInLeft">
								<img class="img-fluid" src="/_web/images/img-13.png" alt="content-image">
							</div>
						</div>
					...
					<div class="row">
						<div class="col">
							<div class="img-block wow fadeInUp">
								<img class="img-fluid" src="/_web/images/img-19.png" alt="video-preview">
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col">
							<div class="img-block-btn text-center wow fadeInUp">
								...
								<!-- Button -->
								<a href="#integrations-2" class="btn r-04 btn--tra-black hover--pink-400">Monitor your activity</a>
			...
			<section class="py-100 ct-02 content-section division">
				<div class="container">
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-6">
							<div class="img-block left-column wow fadeInRight">
								<img class="img-fluid" src="/_web/images/img-09.png" alt="content-image">
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="txt-block right-column wow fadeInLeft">
								...
								<div class="cbox-2 process-step">
									...
									<!-- Icon -->
									<div class="ico-wrap">
										<div class="cbox-2-ico bg--pink-400 color--white">1</div>
								...
								<div class="cbox-2 process-step">
									...
									<!-- Icon -->
									<div class="ico-wrap">
										<div class="cbox-2-ico bg--pink-400 color--white">2</div>
										<span class="cbox-2-line"></span>
									</div>
								...
								<div class="cbox-2 process-step">
									...
									<!-- Icon -->
									<div class="ico-wrap">
										<div class="cbox-2-ico bg--pink-400 color--white">3</div>
									</div>
						...
						<div class="row justify-content-md-center row-cols-1 row-cols-md-3">
							...
							<div class="col">
								<div id="rb-1-1" class="rbox-1">
									...
									<div class="rbox-1-img">
										<a href="#"><img class="img-fluid" src="/_web/images/brand-21.png" alt="brand-logo"></a>
									</div>
							...
							<div class="col">
								<div id="rb-1-2" class="rbox-1">
									...
									<!-- Brand Logo -->
									<div class="rbox-1-img">
										<a href="#"><img class="img-fluid" src="/_web/images/brand-22.png" alt="brand-logo"></a>
									</div>
							...
							<div class="col">
								<div id="rb-1-3" class="rbox-1">
									...
									<!-- Brand Logo -->
									<div class="rbox-1-img">
										<a href="#"><img class="img-fluid" src="/_web/images/brand-23.png" alt="brand-logo"></a>
									</div>
						...
						<div class="row row-cols-1 row-cols-sm-3 row-cols-md-5">
							...
							<div class="col">
								<a href="#" class="in_tool it-1 r-12 wow fadeInUp">
									...
									<div class="in_tool_logo ico-65 bg--white-100 block-shadow r-12">
										<img class="img-fluid" src="/_web/images/png_icons/tool-1.png" alt="brand-logo">
									</div>
							...
							<div class="col">
								<a href="#" class="in_tool it-2 r-12 wow fadeInUp">
									...
									<!-- Logo -->
									<div class="in_tool_logo ico-65 bg--white-100 block-shadow r-12">
										<img class="img-fluid" src="/_web/images/png_icons/tool-2.png" alt="brand-logo">
									</div>
							...
							<div class="col">
								<a href="#" class="in_tool it-3 r-12 wow fadeInUp">
									...
									<!-- Logo -->
									<div class="in_tool_logo ico-65 bg--white-100 block-shadow r-12">
										<img class="img-fluid" src="/_web/images/png_icons/tool-3.png" alt="brand-logo">
									</div>
							...
							<div class="col">
								<a href="#" class="in_tool it-4 r-12 wow fadeInUp">
									...
									<!-- Logo -->
									<div class="in_tool_logo ico-65 bg--white-100 block-shadow r-12">
										<img class="img-fluid" src="/_web/images/png_icons/tool-4.png" alt="brand-logo">
									</div>
							...
							<div class="col">
								<a href="#" class="in_tool it-5 r-12 wow fadeInUp">
									...
									<!-- Logo -->
									<div class="in_tool_logo ico-65 bg--white-100 block-shadow r-12">
										<img class="img-fluid" src="/_web/images/png_icons/tool-5.png" alt="brand-logo">
									</div>
						...
						<div class="row">
							<div class="col">
								<div class="more-btn text-center mt-60 wow fadeInUp">
									<a href="integrations.html" class="btn btn--tra-black hover--pink-400">View all integrations</a>
								</div>
							</div>
						</div>
							...
							<div class="more-questions mt-40">
								<div class="more-questions-txt bg--white-400 r-100">
									<p class="p-lg">Have any questions?
										<a href="contacts.html" class="color--pink-400">Get in Touch</a>
									</p>
								</div>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col">
									<div class="banner-3-txt color--white">
										...
										<!-- Button -->
										<a href="signup-1.html" class="btn r-04 btn--pink-400 hover--tra-white">Get srarted - it's free</a>
